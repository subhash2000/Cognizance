...
class Home: UIViewController {
  ...
  @objc  func handelMenuToggle(){
    ...
    func configureNavigationBar(){
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(image: #imageLiteral(resourceName: "Burger Menu Icon").withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handelMenuToggle))
